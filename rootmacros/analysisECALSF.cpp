...
void analysisECALSF() {
    ...
    DrawECALSF(11, 7, sectors, path + "dfSelected_afterFid_afterCorr.root", "dfSelected_afterFid_afterCorr", true, 3, 2, 7.8);
    //DrawECALSF(11, 7, sectors, path + "dfSelected.root", "dfSelected", false, 3, 2, 7.8);
